...
- Reason: proximity and EU data residency for the fictional company, plus current
  Databricks support.
- The existing CLI default of `eu-north-1` must be changed for project profiles.
...
2. Region explicitly set to `eu-west-3`.
